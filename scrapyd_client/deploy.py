...
def parse_args():
    parser = ArgumentParser(
        description="Deploy Scrapy project to Scrapyd server bla"
    )
    parser.add_argument(
        "target", nargs="?", default="default", metavar="TARGET"
    )
    parser.add_argument(
...
def main():
    ...
    if opts.list_projects:
        ...
        req = Request(_url(target, "listprojects.json"), headers=headers)
        f = urlopen(req)
